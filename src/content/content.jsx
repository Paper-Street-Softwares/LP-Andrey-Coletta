...
const content = {
  texts: {
    ...
    testimonials: {
      miniTag: 'Depoimentos',
      title: 'Confiança construída em cada caso',
      subtitle:
        'Relatos reais de clientes que encontraram orientação, segurança e resultados através de uma atuação jurídica séria e comprometida.',
      images: {
        img1: {
          img: imgTestimonial1,
